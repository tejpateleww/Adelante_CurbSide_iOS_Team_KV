...
class myaccountLabel : UILabel {
    ...
    override func awakeFromNib() {
        if isUserName {
            ...
            self.font = FontBook.bold.font(ofSize: 18)
            self.textColor = colors.black.value
        } else if isSubDetails {
            self.textAlignment = .left
            self.font = FontBook.regular.font(ofSize: 14)
            self.textColor = colors.black.value
        } else if isVersion{
...
class CheckOutLabel : UILabel {
    ...
    override func awakeFromNib() {
        if isUserName {
            self.font = FontBook.bold.font(ofSize: 20)
            self.textColor = colors.black.value
            self.textAlignment = .left
        } else if isAddress {
            self.font = FontBook.regular.font(ofSize: 13)
            self.textColor = colors.black.value
            self.textAlignment = .left
        } else if isYourOrder {
            self.font = FontBook.bold.font(ofSize: 18)
            ...
            self.font = FontBook.regular.font(ofSize: 15)
            self.textColor = colors.black.value
            self.textAlignment = .left
        } else if isYourOrderPrice {
            self.font = FontBook.bold.font(ofSize: 15)
            self.textColor = colors.black.value
            ...
            self.font = FontBook.regular.font(ofSize: 12)
            self.textColor = colors.black.value
            self.textAlignment = .center
        } else if isProductName {
            self.font = FontBook.bold.font(ofSize: 14)
            self.textColor = colors.black.value
            self.textAlignment = .left
        }
            ...
            self.font = FontBook.regular.font(ofSize: 10)
            self.textColor = colors.black.value
            self.textAlignment = .left
        }
...
class addPaymentlable : UILabel {
    ...
    override func awakeFromNib() {
        if isWallet {
            ...
            self.font = FontBook.light.font(ofSize: 13)
...
class addCardLabel : UILabel {
    ...
    override func awakeFromNib() {
        self.font = FontBook.regular.font(ofSize: 11)
        self.textColor = UIColor(hexString: "#ACB1C0")
        self.textAlignment = .left
        if isDetailsTitle {
            self.font = FontBook.regular.font(ofSize: 12)
...
class sortPopUPLabel : UILabel {
    ...
    override func awakeFromNib() {
        self.textColor = colors.black.value
        self.font = FontBook.regular.font(ofSize: 18)
        
        if isTitle {
            self.textColor = colors.black.value
            self.font = FontBook.bold.font(ofSize: 25)
...
class commonPopUPLabel : UILabel {
    ...
    override func awakeFromNib() {
        ...
        self.font = FontBook.regular.font(ofSize: 20)
...
class commonPopupButton : UIButton {
    override func awakeFromNib() {
        ...
        self.titleLabel?.font = FontBook.bold.font(ofSize: 14)
...
class themeTitleLabel : UILabel {
    ...
    override func awakeFromNib() {
        ...
        if isWelcomeTitle {
            self.font = FontBook.bold.font(ofSize: 41)
            self.textAlignment = .left
...
class myLocationLabel : UILabel {
    ...
    override func awakeFromNib() {
        ...
        if isHeader {
            ...
            self.font = FontBook.bold.font(ofSize: 16)
        } else {
...
class themeLabel: UILabel {
    ...
    override func awakeFromNib() {
        ...
        if isUnderline {
            ...
            self.backgroundColor = .clear
            self.font = FontBook.bold.font(ofSize: 26)
        } else if isSignin{
            self.backgroundColor = .clear
            self.font = FontBook.bold.font(ofSize: 30)
        } else if isCreateAccount {
            self.backgroundColor = .clear
            self.font = FontBook.bold.font(ofSize: 28)
        } else if isForgotPassword {
            self.backgroundColor = .clear
            self.font = FontBook.bold.font(ofSize: 26)
        } else if isVerified{
            self.font = FontBook.bold.font(ofSize: 12)
            ...
            self.font = FontBook.regular.font(ofSize: 17)
...
class colVwRestaurantLabel: UILabel {
    ...
    override func awakeFromNib() {
        ...
        if isRestaurantTitle {
            self.font = FontBook.bold.font(ofSize: 23)
...
class tblHomeLabels: UILabel {
    ...
    override func awakeFromNib() {
        ...
        if isRestaurantName {
            ...
            self.font = FontBook.bold.font(ofSize: 13)
        } else if isDistance {
            self.font = FontBook.bold.font(ofSize: 12)
            self.textAlignment = .right
        }  else if isRating {
            self.font = FontBook.regular.font(ofSize: 9)
            self.textAlignment = .left
        }
    }
    override func drawText(in rect: CGRect) {
...
class tblMyOrdersLabel: UILabel {
    ...
    override func awakeFromNib() {
        ...
        self.textColor = colors.black.value
        if isTitle {
            self.font = FontBook.bold.font(ofSize: 21)
        } else if isLocation {
            self.font = FontBook.regular.font(ofSize: 12)
        } else if isPrice {
            self.font = FontBook.bold.font(ofSize: 14)
...
class orderDetailsLabel:UILabel {
    ...
    override func awakeFromNib() {
        ...
        if isOrderId {
            ...
            self.font = FontBook.bold.font(ofSize: 24)
        } else if isLocation {
            self.font = FontBook.bold.font(ofSize: 14)
        } else if isAddress {
            self.font = FontBook.regular.font(ofSize: 13)
...
class promocodeLabel : UILabel{
    ...
    override func awakeFromNib() {
        ...
        if OrderNAme{
            ...
            self.font = FontBook.regular.font(ofSize: 23)
            self.textColor = UIColor.black
        }
    }
}
