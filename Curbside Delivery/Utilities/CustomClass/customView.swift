...
class myOrdersSegmentControl: BetterSegmentedControl {
    override func awakeFromNib() {
        super.awakeFromNib()
        self.segments = LabelSegment.segments(withTitles: ["Pending","Completed"], numberOfLines: 1, normalBackgroundColor: colors.segmentDeselectedColor.value, normalFont: FontBook.regular.font(ofSize: 16), normalTextColor: colors.black.value.withAlphaComponent(0.29), selectedBackgroundColor: colors.segmentSelectedColor.value, selectedFont: FontBook.bold.font(ofSize: 16), selectedTextColor: colors.black.value)
