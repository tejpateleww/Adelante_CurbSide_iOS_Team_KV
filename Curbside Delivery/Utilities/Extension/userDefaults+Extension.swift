...
extension UserDefaults{
    ...
    func getUserData() -> LoginResponseDatum? {
        let objResponse = try? UserDefaults.standard.get(objectType: LoginResponseDatum.self, forKey:  UserDefaultsKey.userProfile.rawValue)
