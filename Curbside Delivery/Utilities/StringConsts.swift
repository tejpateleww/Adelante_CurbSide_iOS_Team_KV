...
enum StringConsts {
    ...
    static let UrlConstant_SomethingWentWrong = "There is some server side error, Please try again after some time!"
    static let ResponseMessage = "message"
    static let SessionExpired = "Your session is expired! Please login again."
    static let SomethingWentWrong = "Your session is expired! Please login again."
    ...
    static let NotiSessionExpired = "Session Expired"
